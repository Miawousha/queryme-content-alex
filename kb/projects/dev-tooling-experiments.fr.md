...
repos:
  ...
  - name: article-checker
    role: author
    visibility: private
    description: Prototype CRA de 2023 qui note l'objectivité et la cohérence
...
en %, cohérence logique en %), et un `AnswerCard` listant les figures
