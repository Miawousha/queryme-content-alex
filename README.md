# Alexandre Collet — career & achievements
...
Edit any file and push to `main`. With the Queritae GitHub App installed, every push
auto-syncs the live page — no manual step needed. (The **Sync** button in the admin
Content tab remains as a manual fallback.)
